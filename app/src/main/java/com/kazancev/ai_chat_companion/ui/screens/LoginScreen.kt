...
fun LoginScreen(navController: NavController, authViewModel: AuthViewModel) {
    ...
    Box(
        ...
        Column(
            ...
            Text(tr("С возвращением"), color = AppColors.text, fontSize = 27.sp, fontWeight = FontWeight.Bold)
            Text(tr("Войдите, чтобы продолжить общение"), color = AppColors.subtleText, fontSize = 16.sp)
                ...
                Column(
                    ...
                    Button(
                        ...
                        if (authState.isLoading) {
                            ...
                            Text(tr("Войти"), color = Color.White, fontSize = 17.sp, fontWeight = FontWeight.SemiBold)
                        }
                    }
                }
            }
